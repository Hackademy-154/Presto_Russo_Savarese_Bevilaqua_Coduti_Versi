            ...
            <div class="dropdown-menu dropdown-menu1 dropdown-menu-end p-3" aria-labelledby="navbarDropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="nav-item revisorButton">
                      <a class="nav-link position-relative w-sm-25"
                        href="{{ route('revisor.index') }}">Zona Revisor
                        <span
                        class="badge bg-warning position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" >{{ \App\Models\Announcement::countAttendToRevise() }}</span>
                      </a>
                    </li>
                    @endif
                @else
