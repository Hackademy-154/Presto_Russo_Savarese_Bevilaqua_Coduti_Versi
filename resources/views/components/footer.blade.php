<footer class="py-3 container-fluid background-footer mt-5">
    <div class="px-3 row justify-content-between">
        ...
        <div class="col-12 col-md-2 mb-2">
            <h5 class="text-nowrap text-center fw-bold"><i class="bi bi-question-circle"></i> Aiuto & Contatti</h5>
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-1"><a href="#" class="nav-link p-0 text-body-secondary">Lavora con noi, Diventa Un Revisor! </a></li>
                <li class="nav-item mt-2">
                    <h5 class="text-start fw-bold bi bi-person-workspace"> Lavora Con Noi</h5>
                    <p class="text-start text-nowrap " style="font-size: 15px">Cliccando Il Bottone SottoStante <br> Farai Una Richiesta Al Nostro Amministratore</p>
            ...
            <ul class="nav flex-wrap justify-content-center">
                <li class="nav-item mx-1 my-1"><a href="#" class="nav-link p-0"><img class="img-fluid footer-icon-size"
                    ...
                    <li class="nav-item mx-1 my-1"><a href="#" class="nav-link p-0"><img class="img-fluid footer-icon-size"
                        ...
                        <li class="nav-item mx-1 my-1"><a href="#" class="nav-link p-0"><img class="img-fluid footer-icon-size"
                            src="{{ asset('icons/Logo-GLS-1080x1080px.svg.png') }}" alt="gls"></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-12 col-md-2 mb-2">
                        ...
                        <div class="col-12 col-md-4 mb-2">
                            <h5 class="text-center fw-bold">SEGUICI SUI SOCIAL</h5>
